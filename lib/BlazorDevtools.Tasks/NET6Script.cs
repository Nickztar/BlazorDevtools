...
{
    public static class NET6Script
    {
        ...
        (()=>{
                ...
                dispatchGlobalEventToAllElements(e, t) {
                    ...
                    for (; o; ) {
                        ...
                        if (m) {
                            ...
                            if (n && (u = f,
                            d = t.type,
                            !((u instanceof HTMLButtonElement || u instanceof HTMLInputElement || u instanceof HTMLTextAreaElement || u instanceof HTMLSelectElement) && O.hasOwnProperty(d) && u.disabled))) {
                                if (!a) {
                                    const n = i(e);
            ...
            const ge = {
                listenForNavigationEvents: function(e) {
                    ye = e,
                    pe || (pe = !0,
                    window.addEventListener("popstate", (()=>ve(!1))))
                },
            ...
            let Ee;
            function _e(e) {
                return Ee = Ee || document.createElement("a"),
                Ee.href = e,
                Ee.href
            }
            function Ie(e, t) {
            ...
            const Oe = {
                getAndRemoveExistingTitle: function() {
                    ...
                    for (let r = t.length - 1; r >= 0; r--) {
                        const o = t[r]
                            , s = o.previousSibling;
                        s instanceof Comment && null !== $(s) || (null === n && (n = o.textContent),
            ...
            const Be = new Map
                ...
                _internal: {
                    ...
                    receiveDotNetDataStream: function(t, n, r, o) {
                        ...
                        o ? (s.error(o),
                        Be.delete(t)) : 0 === r ? (s.close(),
                        Be.delete(t)) : s.enqueue(n.length === r ? n : n.subarray(0, r))
                    },
            ...
            const Xe = {
                start: function(t) {
                    return new Promise(((n,r)=>{
                        (function(e) {
                            Le = !!e.bootConfig.resources.pdb,
                            Pe = e.bootConfig.debugBuild;
                        ...
                        function(o) {
                            ...
                            window.__wasmmodulecallback__ = ()=>{
                                window.Module = function(t, n, r) {
                                    ...
                                    let f, m;
                                    if (t.bootConfig.resources.runtime.hasOwnProperty(d) && (f = t.loadResource(d, "_framework/dotnet.timezones.blat", t.bootConfig.resources.runtime["dotnet.timezones.blat"], "globalization")),
                                    t.bootConfig.icuDataMode != Ue.Invariant) {
                                        const e = t.startOptions.applicationCulture || navigator.languages && navigator.languages[0]
                                            , n = function(e, t) {
                                            if (!t || e.icuDataMode === Ue.All)
                                                return "icudt.dat";
                                            const n = t.split("-")[0];
                                    ...
                                    s.preRun.push((()=>{
                                        ...
                                        Fe._internal.getSatelliteAssemblies = e=>{
                                            ...
                                            if (t.startOptions.applicationCulture || navigator.languages && navigator.languages[0],
                                            r) {
                                        ...
                                        Fe._internal.getLazyAssemblies = n=>{
                                            ...
                                            return BINDING.js_to_mono_obj(Promise.all([c, i]).then((t=>(e.assemblies = t[0],
                                            e.pdbs = t[1],
                                            e.assemblies.length && (Fe._internal.readLazyAssemblies = ()=>{
                                    ...
                                    s.postRun.push((()=>{
                                        ...
                                        t.bootConfig.icuDataMode === Ue.Sharded && (MONO.mono_wasm_setenv("__BLAZOR_SHARDED_ICU", "1"),
                                        t.startOptions.applicationCulture && MONO.mono_wasm_setenv("LANG", `${t.startOptions.applicationCulture}.UTF-8`));
                                        let r = "UTC";
                                        try {
                                    ...
                                    async function h(e, t) {
                                        ...
                                        try {
                                            ...
                                            ze(t, s, r.length),
                                            MONO.loaded_files.push((o = e.url,
                                            Ye.href = o,
                                            Ye.href))
                                        } catch (e) {
                                            return void r(e)
                                ...
                                function(e) {
                                    ...
                                    e.startOptions.loadBootResource) {
                                        ...
                                        if ("string" == typeof s)
                                            ...
                                            throw new Error(`For a ${o} resource, custom loaders must supply a URI string.`)
                                    }
                ...
                readStringField: function(e, t, n) {
                    ...
                    let o;
                    return Ke ? (o = Ke.stringCache.get(r),
                    void 0 === o && (o = BINDING.conv_string(r),
                    Ke.stringCache.set(r, o))) : o = BINDING.conv_string(r),
                    o
                },
            ...
            class nt {
                ...
                release() {
                    ...
                    for (Ke = null; null === (e = this.postReleaseActions) || void 0 === e ? void 0 : e.length; )
            ...
            class ut {
                ...
                logToConsole() {
                    ...
                    e.length && (console.groupCollapsed(`Loaded ${ft(n)} resources from cache`),
                    console.table(this.cacheLoads),
                    console.groupEnd()),
                    t.length && (console.groupCollapsed(`Loaded ${ft(r)} resources from network`),
            ...
            Fe.start = At,
            document && document.currentScript && "false" !== document.currentScript.getAttribute("autostart") && At().catch((e=>{
