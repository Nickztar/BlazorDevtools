...
{
    public static class Net7Script
    {
        //This is a formatted version of blazor.webassembly script. Search for #CHANGE# to see the only change.
            ...
            (()=>{
                ...
                !function(e) {
                    ...
                    class I {
                        constructor(e) {
                            if (r.has(e))
                                this._streamPromise = r.get(e).streamPromise,
                                r.delete(e);
                            else {
                                const t = new S;
                                r.set(e, t),
                    ...
                    dispatchGlobalEventToAllElements(e, t) {
                        ...
                        for (; o; ) {
                            ...
                            if (m) {
                                ...
                                if (n && (u = f,
                                d = t.type,
                                !((u instanceof HTMLButtonElement || u instanceof HTMLInputElement || u instanceof HTMLTextAreaElement || u instanceof HTMLSelectElement) && Object.prototype.hasOwnProperty.call(k, d) && u.disabled))) {
                                    if (!a) {
                                        const n = i(e);
                ...
                function x(e, t, n) {
                    const r = e;
                    if (e instanceof Comment && U(r) && U(r).length > 0)
                ...
                class se {
                    ...
                    insertFrame(e, t, r, o, s, a, i) {
                        ...
                        switch (l) {
                        case n.element:
                            return this.insertElement(e, t, r, o, s, a, i),
                            1;
                        case n.text:
                            return this.insertText(e, r, o, a),
                            1;
                        case n.attribute:
                            throw new Error("Attribute frames should only be present as leading children of element frames.");
                        case n.component:
                            return this.insertComponent(e, r, o, a),
                            1;
                        case n.region:
                        ...
                        case n.markup:
                            return this.insertMarkup(e, r, o, a),
                            1;
                        default:
                    ...
                    insertElement(e, t, r, o, s, a, i) {
                        ...
                        for (let a = i + 1; a < m; a++) {
                            ...
                            if (c.frameType(i) !== n.attribute) {
                                x(u, r, o),
                                f = !0,
                                this.insertFrameRange(e, t, d, 0, s, a, m);
                                break
                            }
                            this.applyAttribute(e, t, u, i)
                        }
                        f || x(u, r, o),
                        u instanceof HTMLOptionElement ? this.trySetSelectValueFromOptionElement(u) : Z in u && ue(u, u._blazorDeferredValue)
                    }
                    ...
                    tryApplySpecialProperty(e, t, n, r) {
                        ...
                        default:
                            return !!n.startsWith(ne) && (this.applyInternalAttribute(e, t, n.substring(ne.length), r),
                            !0)
                        }
                    }
                    ...
                    tryApplyValueProperty(e, t, n) {
                        ...
                        case "SELECT":
                        case "TEXTAREA":
                            return o && t instanceof HTMLSelectElement && ce(t) && (o = JSON.parse(o)),
                            ue(t, o),
                    ...
                    insertFrameRange(e, t, n, r, o, s, a) {
                        ...
                        for (let i = s; i < a; i++) {
                            ...
                            r += this.insertFrame(e, t, n, r, o, s, i),
                            i += ae(e, s)
                        }
                        return r - i
                    }
                ...
                const Ce = {
                    listenForNavigationEvents: function(e, t) {
                        ...
                        ge = null !== (r = null === (n = history.state) || void 0 === n ? void 0 : n._index) && void 0 !== r ? r : 0)
                    },
                ...
                async function Oe(e) {
                    var t, n;
                    Ee && await Ee(e),
                    ge = null !== (n = null === (t = history.state) || void 0 === t ? void 0 : t._index) && void 0 !== n ? n : 0
                }
                let Fe;
                function Te(e) {
                    return Fe = Fe || document.createElement("a"),
                    Fe.href = e,
                    Fe.href
                }
                function je(e, t) {
                ...
                const xe = {
                    getAndRemoveExistingTitle: function() {
                        ...
                        for (let r = t.length - 1; r >= 0; r--) {
                            const o = t[r]
                            , s = o.previousSibling;
                            s instanceof Comment && null !== H(s) || (null === n && (n = o.textContent),
                ...
                , $e = {
                    ...
                    toImageFile: async function(e, t, n, r, o) {
                        ...
                        , i = await new Promise((function(e) {
                            ...
                            null === (t = l.getContext("2d")) || void 0 === t || t.drawImage(a, 0, 0, l.width, l.height),
                            l.toBlob(e, n)
                        }
                        ))
                        , c = {
                ...
                , ze = {
                    enableNavigationPrompt: function(e) {
                        0 === Je.size && window.addEventListener("beforeunload", Ue),
                        Je.add(e)
                    },
                    disableNavigationPrompt: function(e) {
                        Je.delete(e),
                        0 === Je.size && window.removeEventListener("beforeunload", Ue)
                    }
                };
                function Ue(e) {
                    e.preventDefault(),
                ...
                , Ke = {
                    ...
                    _internal: {
                        ...
                        domWrapper: Le,
                        browserRenderers: de, //#CHANGE# This is the only change made, exposes the browser renderer to be able to match element
                        Virtualize: Be,
                        PageTitle: xe,
                        InputFile: $e,
                        NavigationLock: ze,
                        ...
                        receiveDotNetDataStream: function(t, n, r, o) {
                            ...
                            o ? (s.error(o),
                            We.delete(t)) : 0 === r ? (s.close(),
                            We.delete(t)) : s.enqueue(n.length === r ? n : n.subarray(0, r))
                        },
                ...
                , Qe = Ze ? Ze.some((e=>"Google Chrome" === e.brand || "Microsoft Edge" === e.brand)) : window.chrome
                ...
                class at {
                    ...
                    static async initAsync(e, t) {
                        ...
                        , s = await r.json();
                        return s.modifiableAssemblies = r.headers.get("DOTNET-MODIFIABLE-ASSEMBLIES"),
                ...
                const yt = {
                    start: async function(t) {
                        (function(e) {
                            tt = !!e.bootConfig.resources.pdb,
                            nt = e.bootConfig.debugBuild;
                            const t = et.match(/^Mac/i) ? "Cmd" : "Alt";
                            rt() && console.info(`Debugging hotkey: Shift+${t}+D (when application has focus)`),
                        ...
                        await async function(t) {
                            ...
                            , s = async function(e) {
                                ...
                                if (e.startOptions.loadBootResource) {
                                    ...
                                    if ("string" == typeof s)
                                        ...
                                        throw new Error(`For a ${r} resource, custom loaders must supply a URI string.`)
                                }
                                ...
                                , {default: i} = await import(a);
                                return i ? (delete globalThis.__onDotnetRuntimeLoaded,
                                i) : await s
                            }(t)
                            , a = t.bootConfig.resources
                            , i = window.Module || {}
                            , c = ["DEBUGGING ENABLED"]
                            , l = e=>c.indexOf(e) < 0 && console.log(e)
                            , u = e=>{
                                console.error(e),
                                st()
                            }
                            ...
                            function h() {
                                ...
                                document.documentElement.style.setProperty("--blazor-load-percentage", `${e}%`),
                                document.documentElement.style.setProperty("--blazor-load-percentage-text", `"${Math.floor(e)}%"`)
                            }
                            ...
                            let v, E;
                            if (t.bootConfig.resources.runtime.hasOwnProperty(w) && (v = t.loadResource(w, "_framework/dotnet.timezones.blat", t.bootConfig.resources.runtime["dotnet.timezones.blat"], "globalization"),
                            b.push(v),
                            v.response.then((e=>h()))),
                            t.bootConfig.icuDataMode !== it.Invariant) {
                                const e = t.startOptions.applicationCulture || navigator.languages && navigator.languages[0]
                                , n = function(e, t) {
                                    if (!t || e.icuDataMode === it.All)
                                        return "icudt.dat";
                                    const n = t.split("-")[0];
                                    return ["en", "fr", "it", "de", "es"].includes(n) ? "icudt_EFIGS.dat" : ["zh", "ko", "ja"].includes(n) ? "icudt_CJK.dat" : "icudt_no_CJK.dat"
                                }(t.bootConfig, e);
                                E = t.loadResource(n, `_framework/${n}`, t.bootConfig.resources.runtime[n], "globalization"),
                                b.push(E),
                                E.response.then((e=>h()))
                            }
                            const _ = await s;
                            return await _((o=>{
                                const {MONO: s, BINDING: a, Module: c, IMPORTS: m} = o;
                                async function h(e, t) {
                                    ...
                                    try {
                                        ...
                                        new Uint8Array(ut.HEAPU8.buffer,s,r.length).set(r),
                                        lt.mono_wasm_add_assembly(t, s, r.length),
                                        lt.loaded_files.push((o = e.url,
                                        gt.href = o,
                                        gt.href))
                                    } catch (e) {
                                        return void r(e)
                                ...
                                dt = m,
                                {
                                    ...
                                    preRun: [()=>{
                                        v && async function(e) {
                                            ...
                                            ut.FS_createPath("/", "usr", !0, !0),
                                            ut.FS_createPath("/usr/", "share", !0, !0),
                                            ut.FS_createPath("/usr/share/", "zoneinfo", !0, !0),
                                            lt.mono_wasm_load_data_archive(new Uint8Array(r), "/usr/share/zoneinfo/"),
                                        ...
                                        E && async function(e) {
                                            ...
                                            if (!lt.mono_wasm_load_icu_data(o))
                                                throw new Error("Error loading ICU asset.");
                                            ut.removeRunDependency(t)
                                        }(E),
                                        p.forEach((e=>h(e, Et(e.name, ".dll")))),
                                        y.forEach((e=>h(e, e.name))),
                                        Ke._internal.dotNetCriticalError = e=>u(e || "(null)"),
                                        Ke._internal.getSatelliteAssemblies = e=>{
                                            ...
                                            if (r) {
                                                ...
                                                return ct.js_to_mono_obj(e.then((e=>(e.length && (Ke._internal.readSatelliteAssemblies = ()=>{
                                                    ...
                                                    for (let n = 0; n < e.length; n++)
                                                        ct.mono_obj_array_set(t, n, ct.js_typed_array_to_array(new Uint8Array(e[n])));
                                                    return t
                                                }
                                                ),
                                                e.length))))
                                        ...
                                        Ke._internal.getLazyAssemblies = n=>{
                                            ...
                                            return ct.js_to_mono_obj(Promise.all([i, a]).then((t=>(e.assemblies = t[0],
                                            e.pdbs = t[1],
                                            e.assemblies.length && (Ke._internal.readLazyAssemblies = ()=>{
                                                const {assemblies: t} = e;
                                                if (!t)
                                                    return ct.mono_obj_array_new(0);
                                    ...
                                    postRun: [()=>{
                                        ...
                                        t.bootConfig.icuDataMode === it.Sharded && (lt.mono_wasm_setenv("__BLAZOR_SHARDED_ICU", "1"),
                                        t.startOptions.applicationCulture && lt.mono_wasm_setenv("LANG", `${t.startOptions.applicationCulture}.UTF-8`));
                                        let r = "UTC";
                                        try {
                                            r = Intl.DateTimeFormat().resolvedOptions().timeZone
                                        } catch {}
                                        lt.mono_wasm_setenv("TZ", r || "UTC"),
                                        t.bootConfig.modifiableAssemblies && lt.mono_wasm_setenv("DOTNET_MODIFIABLE_ASSEMBLIES", t.bootConfig.modifiableAssemblies),
                                        t.bootConfig.aspnetCoreBrowserTools && lt.mono_wasm_setenv("__ASPNETCORE_BROWSER_TOOLS", t.bootConfig.aspnetCoreBrowserTools),
                                        lt.mono_wasm_load_runtime("appBinDir", rt() ? -1 : 0),
                                        lt.mono_wasm_runtime_ready();
                                        try {
                                        ...
                                        function() {
                                            ...
                                            e.attachDispatcher({
                                                ...
                                                ,
                                                invokeDotNetFromJS: (e,n,r,o)=>(_t(),
                                                t(e || null, n, r ? r.toString() : null, o))
                                            })
                                        }(),
                                        n(o)
                                    }
                                    ...
                                    instantiateWasm: (e,t)=>((async()=>{
                                        ...
                                        try {
                                            ...
                                            n = await async function(e, t) {
                                                ...
                                                if (o && "function" == typeof WebAssembly.instantiateStreaming)
                                                    return (await WebAssembly.instantiateStreaming(r, t)).instance;
                                                {
                    ...
                    toUint8Array: function(e) {
                        ...
                        , n = pt(t)
                        , r = new Uint8Array(n);
                        return r.set(ut.HEAPU8.subarray(t + 4, t + 4 + n)),
                        r
                    },
                    ...
                    readStringField: function(e, t, n) {
                        ...
                        let o;
                        return ht ? (o = ht.stringCache.get(r),
                        void 0 === o && (o = ct.conv_string(r),
                        ht.stringCache.set(r, o))) : o = ct.conv_string(r),
                        o
                    },
                ...
                class Ct {
                    ...
                    release() {
                        ...
                        for (ht = null; null === (e = this.postReleaseActions) || void 0 === e ? void 0 : e.length; )
                ...
                class Ft {
                    ...
                    logToConsole() {
                        ...
                        console.groupCollapsed(`%cblazor%c Loaded ${jt(o)} resources${s}`, "background: purple; color: white; padding: 1px 3px; border-radius: 3px;", "font-weight: bold;", "font-weight: normal;"),
                        e.length && (console.groupCollapsed(`Loaded ${jt(n)} resources from cache`),
                        console.table(this.cacheLoads),
                        console.groupEnd()),
                        t.length && (console.groupCollapsed(`Loaded ${jt(r)} resources from network`),
                    ...
                    async loadResourceWithCaching(e, t, n, r, o) {
                        ...
                        }
                        {
                            ...
                            return this.addToCacheAsync(e, t, s, a),
                            a
                        }
                    }
                ...
                async function Vt(t) {
                    ...
                    ,
                    Ke._internal.getApplyUpdateCapabilities = ()=>e.invokeMethod("Microsoft.AspNetCore.Components.WebAssembly", "GetApplyUpdateCapabilities"),
                    Ke._internal.invokeJSFromDotNet = Gt,
                    Ke._internal.endInvokeDotNetFromJS = Xt,
                    Ke._internal.receiveByteArray = Yt,
                    Ke._internal.retrieveByteArray = qt;
                    const n = Ge(yt);
                    Ke.platform = n,
                    Ke._internal.renderBatch = (e,t)=>{
                    ...
                    Ke._internal.navigationManager.getUnmarshalledBaseURI = ()=>ct.js_string_to_mono_string(r()),
                    Ke._internal.navigationManager.getUnmarshalledLocationHref = ()=>ct.js_string_to_mono_string(o()),
                    Ke._internal.navigationManager.listenForNavigationEvents((async(t,n,r)=>{
                    ...
                    Ke._internal.getPersistedState = ()=>ct.js_string_to_mono_string(Pt(document) || ""),
                    Ke._internal.attachRootComponentToElement = (e,t,n)=>{
                    ...
                    , d = await async function(e, t) {
                        ...
                        , r = new Wt;
                        return n && await r.importInitializersAsync(Object.keys(n), [t, e.resources.extensions]),
                        r
                    }(u.bootConfig, s)
                    , [f] = await Promise.all([Ft.initAsync(u.bootConfig, s || {}), Dt.initAsync(u)]);
                    try {
                        await n.start(f)
                    } catch (e) {
                    ...
                    d.invokeAfterStartedCallbacks(Ke)
                }
                function Gt(t, n, r, o) {
                    ...
                    if (null !== i) {
                        ...
                        if (0 !== n)
                            return e.jsCallDispatcher.beginInvokeJSFromDotNet(n, s, i, a, c),
                            0;
                        {
                ...
                Ke.start = Vt,
                document && document.currentScript && "false" !== document.currentScript.getAttribute("autostart") && Vt().catch((e=>{
